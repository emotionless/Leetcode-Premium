<h2><a href="https://leetcode.com/problems/choose-numbers-from-two-arrays-in-range/">2143. Choose Numbers From Two Arrays in Range</a></h2><h3>Hard</h3><hr><div><p>You are given two <strong>0-indexed</strong> integer arrays <code>nums1</code> and <code>nums2</code> of length <code>n</code>.</p>
...
<pre><strong>Input:</strong> nums1 = [1,2,5], nums2 = [2,6,3]
...
<pre><strong>Input:</strong> nums1 = [0,1], nums2 = [1,0]
